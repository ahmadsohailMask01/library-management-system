...
const BookForm = ({
  ...
  // Convert uploaded image to Base64 String in order to store in MongoDB database
          ...
          {isModalLoading ? (
            ...
            <Stack spacing={3} paddingY={2} paddingX={3} height="600px" overflow="scroll">
              ...
              <Button size="large" variant="outlined" component="label" color="info">
                Upload photo
                <input type="file" accept="image/jpeg, image/png" hidden onChange={convertToBase64} />
              </Button>
